...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/swipe_profiles.svg
  SvgGenImage get swipeProfiles =>
      const SvgGenImage('assets/svg/swipe_profiles.svg');

  /// List of all assets
  List<SvgGenImage> get values => [swipeProfiles];
}
